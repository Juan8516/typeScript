...
class Gato {
    ...
    public nombre: string; // Propiedad publica de instancia
    protected edad: number; // Propiedad privada de instancia
    private raza: string; // Propiedad privada de instancia
    ...
    set guardarEdad(nuevaEdad: number) {
...
class SuperGato extends Gato {
    ...
    private superpoder: string; // Propiedad privada de instancia adicional

    // La clase SuperGato hereda de la clase Gato
    // Propiedades o atributos adicionales
    constructor(nombre: string, edad: number, raza: string, superpoder: string) {
    ...
    setSuperpoder(nuevoSuperpoder: string) {
